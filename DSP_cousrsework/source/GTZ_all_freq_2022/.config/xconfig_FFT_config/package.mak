...
override PKGDIR = xconfig_FFT_config
...
package/%.xdc.inc package/%_xconfig_FFT_config.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_FFT_config" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: FFT_config.pe66

-include package/cfg/FFT_config_pe66.mak
-include package/cfg/FFT_config_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/FFT_config_pe66.dep
endif
FFT_config.pe66: package/cfg/FFT_config_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
FFT_config.pe66 package/cfg/FFT_config_pe66.c: .libraries,e66
endif

package/cfg/FFT_config_pe66.c package/cfg/FFT_config_pe66.h package/cfg/FFT_config_pe66.xdl: override _PROG_NAME := FFT_config.xe66
package/cfg/FFT_config_pe66.c: package/cfg/FFT_config_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/FFT_config_pe66.cfg
	-$(RM) package/cfg/FFT_config_pe66.dep
	-$(RM) package/cfg/FFT_config_pe66.c
	-$(RM) package/cfg/FFT_config_pe66.xdc.inc

clean,e66::
	-$(RM) FFT_config.pe66
.executables,e66 .executables: FFT_config.xe66

FFT_config.xe66: |FFT_config.pe66

-include package/cfg/FFT_config.xe66.mak
FFT_config.xe66: package/cfg/FFT_config_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/FFT_config_pe66.oe66   package/cfg/FFT_config_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/libc.a
	
FFT_config.xe66: export C_DIR=
FFT_config.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)
FFT_config.xe66: Path:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)

FFT_config.test test,e66 test: FFT_config.xe66.test

FFT_config.xe66.test:: FFT_config.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 FFT_config.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.FFT_config.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,FFT_config.xe66,0,*
...
clean,e66::
	-$(RM) FFT_config.xe66
clean:: 
	-$(RM) package/cfg/FFT_config_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
FFT_config_pe66.oe66,copy : package/cfg/FFT_config_pe66.oe66
FFT_config_pe66.se66,copy : package/cfg/FFT_config_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_FFT_config
xconfig_FFT_config.tar: package/package.bld.xml
xconfig_FFT_config.tar: package/build.cfg
xconfig_FFT_config.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_FFT_config.tar.dep
endif
package/rel/xconfig_FFT_config/xconfig_FFT_config/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_FFT_config.tar: package/rel/xconfig_FFT_config.xdc.inc package/rel/xconfig_FFT_config/xconfig_FFT_config/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_FFT_config.xdc.inc,package/rel/xconfig_FFT_config.tar.dep)


release release,xconfig_FFT_config: all xconfig_FFT_config.tar
clean:: .clean
	-$(RM) xconfig_FFT_config.tar
	-$(RM) package/rel/xconfig_FFT_config.xdc.inc
	-$(RM) package/rel/xconfig_FFT_config.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_FFT_config.pjt
